...
public class WebTablesExamples {
    ...
    public void printTable() {
        // Finding the table where there are more than one. You can use id to make it specific.
    ...
    public void printTableSize() {
        ...
        System.out.println(allRowsWithoutHeader.size());    // 4
    }
